...
/**-
 * @author Jason Edwards (original author)
 * @author Richard North (minor modifications)
 * 
 * This class is based upon HttpProxyServlet by Jason Edwards, 
 * with the following modifications:
 * <ol>
 * 		<li>Removed forwarding of requests to a specific server;
 * 			now behaves as a transparent HTTP proxy</li>
 *      <li>Included observation of response data</li>
 * </ol>
 * 
 * This code remains licenced under the Apache licence, as is the
 * licence applied to HttpProxyServlet.
 * 
 * @see http://edwardstx.net/wiki/Wiki.jsp?page=HttpProxyServlet
 */
...
public class ObserverProxyServlet extends HttpServlet {
	...
	private void executeProxyRequest(HttpMethod httpMethodProxyRequest,
		...
		if (intProxyResponseCode >= HttpServletResponse.SC_MULTIPLE_CHOICES /* 300 */
			...
			// httpServletResponse.sendRedirect(stringMyHostName);
